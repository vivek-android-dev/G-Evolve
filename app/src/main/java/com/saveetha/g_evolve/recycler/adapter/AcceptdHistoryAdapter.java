...
public class AcceptdHistoryAdapter extends RecyclerView.Adapter<AcceptdHistoryAdapter.ViewHolder> {

    ArrayList<HistoryModule> historyModuleArrayList;
    Context context;
    View view;

    public AcceptdHistoryAdapter(ArrayList<HistoryModule> historyModuleArrayList, Context context) {
    ...
    @NonNull
    @Override
    public AcceptdHistoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

//
        View acceptedView = LayoutInflater.from(parent.getContext()).inflate(R.layout.history_acceptedrecyclerview_cell, parent, false);
//p


        return new ViewHolder(acceptedView);

    }

    @SuppressLint("ResourceType")
    @Override
    public void onBindViewHolder(@NonNull AcceptdHistoryAdapter.ViewHolder holder, int position) {
